/*
 * @Author: GengHH
 * @Date: 2022-11-22 15:20:38
 * @LastEditors: GengHH
 * @LastEditTime: 2022-11-22 16:10:26
 * @Description: file content
 * @FilePath: \vue3-vant-mobilee:\工作任务\金保二期\任务\任务36（单位事项随申办）\git-code\eshimin-shrs\postcss.config.cjs
 */
	...
	plugins: [
		...
		pxtorem({
			rootValue({ file }) {
				...
				// return file.indexOf('node_modules/vant') !== -1 ? 37.5 : 75.0;
				return 37.5;
			},
			unitPrecision: 5,
			propList: ['*'],
